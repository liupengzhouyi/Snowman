package teacher_chu.work016.Controller;

import org.apache.commons.dbutils.DbUtils;
import org.apache.commons.dbutils.QueryRunner;
import org.apache.commons.dbutils.handlers.BeanListHandler;
import teacher_chu.work016.Model.Guestbook;
...
@WebServlet(name = "GetGuestBookServlet")
public class GetGuestBookServlet extends HttpServlet {
...
//通过设置响应头控制浏览器以UTF-8的编码显示数据，如果不加这句话，那么浏览器显示的将是乱码
        ...
        try {
            ...
            if (connection == null) {
                ...
                response.sendRedirect("/teacher_chu/016/View/showGeastBooksInformation.jsp");
