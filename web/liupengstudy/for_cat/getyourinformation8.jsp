...
<%
    ...
    String url;
    String number = "2";
    name = request.getParameter("lp_github_name");
    url = request.getParameter("lp_github_url");
    // get today's date
    ...
    lpGetSQLString.setSql8(date, name, url, number);
    String sql = lpGetSQLString.getSql8();
    //
