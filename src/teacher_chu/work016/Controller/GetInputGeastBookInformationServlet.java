...
@WebServlet(name = "GetInputGeastBookInformationServlet")
public class GetInputGeastBookInformationServlet extends HttpServlet {
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    response.sendRedirect("/teacher_chu/016/View/InputSuccsess.jsp");
